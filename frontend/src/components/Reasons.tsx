        ...
        <div className="border-2 border-[#1f1f1f] rounded-2xl p-3 md:p-4 flex flex-col gap-3 md:gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            {reasons.map((reason, index) => (
              <div key={index} className="bg-[#1a1a1a] rounded-xl p-4 md:p-5 flex flex-col gap-4 md:gap-5 transition-all duration-300 hover:scale-105 hover:border-2 hover:border-[#1b4bce] border-2 border-transparent cursor-pointer">
